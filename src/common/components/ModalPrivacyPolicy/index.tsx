...
import classes from './ModalPrivacyPolicy.module.css';

interface Props {
  onClose: () => void;
}

const ModalPrivacyPolicy: React.FC<Props> = ({ onClose }) => {
  return (
    <Modal
      title="Политика конфиденциальности"
      onClose={onClose}
      renderFooter={() => (
        <Button className={classes.btnModal} type="button" onClick={onClose}>
          Я согласен
        </Button>
      )}
    >
